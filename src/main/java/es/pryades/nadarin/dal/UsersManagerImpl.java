...
import es.pryades.nadarin.dal.ibatis.UserMapper;
	...
	public void setPassword(AppContext ctx, User usuario, String subject, String text, boolean mail ) throws BaseException
	{
		...
		try
		{
			...
			if ( mail )
			{
				...
				Utils.sendMail( from, usuario.getEmail(), subject, host, port, sender, password, text, null, proxyHost, proxyPort, "true".equals( ctx.getParameter( Parameter.PAR_MAIL_AUTH ) ) );
			}
